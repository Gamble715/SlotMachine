...
//  Slot Machine
//
//  Created by Gamble McAdam on 12/16/14.
//  Copyright (c) 2014 Gamble. All rights reserved.
//
...
//    IBActions
    ...
    func betMaxButtonPressed (button: UIButton) {
        if credits <= 5 {
            showAlertWithText(header: "Not EnoughCredits", message: "Bet less")
        }
        else {
            if currentBet < 5 {
    ...
    func setupThirdContainer (containerView:UIView) {
        ...
        self.creditsTitleLabel.font = UIFont(name: "AmericanTypwriter", size: 14)
